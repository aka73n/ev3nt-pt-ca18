...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-[rgba(var(--theme-base-rgb),0.12)] data-[highlighted]:text-[var(--theme-color)] data-[state=checked]:text-[var(--theme-color)]",
      className,
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-[var(--theme-color)]" />
      </SelectPrimitive.ItemIndicator>
    </span>
